...
def check_and_add_missing_columns():
    ...
    try:
        ...
        existing_columns = [col['name'] for col in inspector.get_columns('tool_categories')]
        ...
        # Verify the changes
        updated_columns = [col['name'] for col in inspector.get_columns('tool_categories')]
            ...
            if stage.name in default_categories:
                for cat_data in default_categories[stage.name]:
                    ...
                    if not existing_category:
                        ...
                        logger.info(f"Created category: {cat_data['name']} for stage: {stage.name}")
